...
def normalizasyon(numbers):
    ...
    for x in numbers:#her sayıdan ortalama çıkart standart sapmaya böl
...
def get_mean_one_std_neighbor_ratio(numbers):
    ...
    #belli aralıklarda sayıların gelme olasılığı
...
#insertion sort---------------
#daha önceki sayıları karşılaştır ihtiyaç varsa yer değiştir. 
...
def get_mean_of_swap_in_insertion(num_trials,num_int):
    ...
    for i in range(num_trials):
        ...
        s_1 = sayilar_2[1]#yer değiştirme sayisini bana ver
...
print("normalizasyon ortalaması : ",get_mean_for_n_integer(yeni_sayilar))
